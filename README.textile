...
In order to access the documents in the folder, you have to create a document class that includes @DocumentMapper@. Inside the class definition, you must set the @documents_dir@ class variable in order to tell Document Mapper where to look for files. In our little example, we will do the following and assume the above file has been saved as @./documents/2010-09-13-ruby-stuff.textile@:
